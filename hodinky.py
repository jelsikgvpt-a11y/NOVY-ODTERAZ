...
canvas.create_oval(s1 - dlha_ruc - 20, s2 - dlha_ruc - 20, s1 + dlha_ruc + 20, s2 + dlha_ruc + 20, outline="black", width=2)
for i in range(12): 
    uhol = math.radians(i * 30 - 90)
    x = s1 + (dlha_ruc + 10) * math.cos(uhol)
    y = s2 + (dlha_ruc + 10) * math.sin(uhol)
